...
public class campLt extends AppCompatActivity implements GoogleMap.OnMapLoadedCallback, OnMapReadyCallback {

    private GoogleMap gMap;
    private ViewPager imagePager;
    private LinearLayout dotsLayout;
    private int[] imageIds = {R.drawable.campo1, R.drawable.campo2, R.drawable.campo3,
            R.drawable.campo4}; // Add your image resources here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camp_lt);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(campLt.this, touristCategory.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(campLt.this, HomePage.class);
                startActivity(intent);
            }
        });
        ...
        marketButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(campLt.this, marketing.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        LatLng location = new LatLng(16.525417, 120.390778);
        googleMap.addMarker(new MarkerOptions().position(location).title("Camp Lt. Col. Jose M. Laberinto"));
