...
public class mangkaeng extends AppCompatActivity implements GoogleMap.OnMapLoadedCallback, OnMapReadyCallback {

    private GoogleMap gMap;
    private ViewPager imagePager;
    private LinearLayout dotsLayout;
    private int[] imageIds = {R.drawable.mangkaeng1, R.drawable.mangkaeng2, R.drawable.mangkaeng3,
            R.drawable.mangkaeng4, R.drawable.mangkaeng5}; // Add your image resources here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangkaeng);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mangkaeng.this, touristCategory.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mangkaeng.this, HomePage.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        LatLng location = new LatLng(16.561278, 120.442250);
        googleMap.addMarker(new MarkerOptions().position(location).title("Mangkaeng Memorial Site"));
