...
public class daughters extends AppCompatActivity implements GoogleMap.OnMapLoadedCallback, OnMapReadyCallback {

    private GoogleMap gMap;
    private ViewPager imagePager;
    private LinearLayout dotsLayout;
    private int[] imageIds = {R.drawable.daughters1, R.drawable.daughters2, R.drawable.daughters3}; // Add your image resources here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daughters);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(daughters.this, touristCategory.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(daughters.this, HomePage.class);
                startActivity(intent);
            }
        });
        ...
        marketButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(daughters.this, marketing.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        LatLng location = new LatLng(16.510278, 120.404583);
        googleMap.addMarker(new MarkerOptions().position(location).title("Daughters Of Mary Consolatrix Monastery"));
