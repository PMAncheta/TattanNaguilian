...
public class gabaldon extends AppCompatActivity implements GoogleMap.OnMapLoadedCallback, OnMapReadyCallback {

    private GoogleMap gMap;
    private ViewPager imagePager;
    private LinearLayout dotsLayout;
    private int[] imageIds = {R.drawable.gabaldon1, R.drawable.gabaldon2, R.drawable.gabaldon3,
            R.drawable.gabaldon4, R.drawable.gabaldon5, R.drawable.gabaldon6, R.drawable.gabaldon7,
            R.drawable.gabaldon8}; // Add your image resources here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gabaldon);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(gabaldon.this, touristCategory.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(gabaldon.this, HomePage.class);
                startActivity(intent);
            }
        });
        ...
        marketingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(gabaldon.this, marketing.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        LatLng location = new LatLng(16.532472, 120.391361);
        googleMap.addMarker(new MarkerOptions().position(location).title("Gabaldon Building (Dr. Hermogenes F. Belen Elementary School)"));
